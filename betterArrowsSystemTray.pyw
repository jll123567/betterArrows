...
#              link where I got it<https://stackoverflow.com/questions/9494739/how-to-build-a-systemtray-app-for-windows>
...
if __name__ == '__main__':
    ...
    menu_options = (('Start betterArrows', next(icons), start),)
